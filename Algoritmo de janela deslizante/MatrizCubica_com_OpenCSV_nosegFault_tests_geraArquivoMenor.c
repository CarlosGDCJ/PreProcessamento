...
void slidingWindowMultipleColumns(String **solarDataSet, int futureWindowSize, int jump, char *filename, float tupleQty, int presentWindowSize, int step, int totalArrayLength, int numColumn) {
		...
		*(strSave + cont) = '\n';
		...
		for (cont=0,i = 1; i < 2000; i++)//tupleQty; i++) //alterei aqui para testes....
		{
...
strcpy(vetPathFile,"/home/carlos/Downloads/EntradasJanelaDesl/sergio2010.csv");

strcpy(vetPathFileSlided,"/home/carlos/Downloads/SaidasJanelaDesl/sergio2010slided.csv");
