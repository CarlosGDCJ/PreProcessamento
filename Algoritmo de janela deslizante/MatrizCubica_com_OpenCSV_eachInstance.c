...
void slidingWindowMultipleColumns(String **solarDataSet, int futureWindowSize, int jump, char *filename, float tupleQty, int presentWindowSize, int step, int totalArrayLength, int numColumn) {
		...
		*(strSave + cont) = '\n';
		...
		for (i = 1; i < tupleQty; i++)
		{
			...
			//Se der problema MUDAR AQUI TAMBÉM!!!!
...
strcpy(vetPathFile,"/home/marcela/Documentos/01_Doutorado/_01_ArquivosDR/05_Experimentos/18_Base_50_porcento_raios_X_meanjzh/xray.csv");
...
strcpy(vetPathFileSlided,"/home/marcela/Documentos/01_Doutorado/_01_ArquivosDR/05_Experimentos/18_Base_50_porcento_raios_X_meanjzh/xray_slided_eachInstance.csv");
////commented below	
